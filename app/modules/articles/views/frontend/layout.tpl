...
<link rel="stylesheet" href="{$website_path}/app/modules/articles/views/frontend/css/articles.css" />
...
<div class="row">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="{$website_path}/articles/search" method="post" name="search">
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" class="form-control" name="articles_search" placeholder="Search">
