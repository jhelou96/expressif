...
{config_load file="app/modules/articles/lang/{$website_lang}/frontend/editArticle.php"}

{block name=title}{#editArticle#} &bull; {#myArticles#} &bull; {/block}
...
<ol class = "breadcrumb" style="margin-top:-20px; padding-left: 50px;">
	...
	<li class="active">{#editArticle#}</li>
</ol>
...
<div class="row">
	<div class="col-lg-12">
		...
		<form class="form-horizontal" action="{$website_path}/articles/my-articles/edit/{$article_id}" method="post">
